...
.cta-btn
  ...
  &.btn-activate
    animation: btn-activate 0.8s ease-out forwards
...
@keyframes btn-activate
  ...
  50%
    transform: scale(1.1)
    box-shadow: 0 0 40px var(--q-primary), 0 0 60px var(--q-accent)
  100%
    transform: scale(1)
    box-shadow: 0 0 25px var(--q-primary)
